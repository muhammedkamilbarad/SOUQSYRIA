...
class AdvertisementSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->createCarAdvertisements($faker, $users, $cities, $carCategoryId, $colors, $fuelTypes, 
            $transmissions, $features, $advertisementTypes, $adsStatusOptions, $activeStatusOptions, $vehicleConditions, 1000);
            
        // Create Motorcycle Advertisements (5)
        $this->createMotorcycleAdvertisements($faker, $users, $cities, $motorcycleCategoryId, $colors, $fuelTypes, 
            $transmissions, $features, $advertisementTypes, $adsStatusOptions, $activeStatusOptions, $vehicleConditions, 1000);
            
        // Create Marine Advertisements (5)
        $this->createMarineAdvertisements($faker, $users, $cities, $marineCategoryId, $colors, $fuelTypes, 
            $transmissions, $marineTypes, $features, $advertisementTypes, $adsStatusOptions, $activeStatusOptions, $vehicleConditions, 1000);
            
        // Create House Advertisements (10)
        $this->createHouseAdvertisements($faker, $users, $cities, $houseCategoryId, $features, 
            $advertisementTypes, $adsStatusOptions, $activeStatusOptions, 1000);
            
        // Create Land Advertisements (5)
        $this->createLandAdvertisements($faker, $users, $cities, $landCategoryId, $features, 
            $advertisementTypes, $adsStatusOptions, $activeStatusOptions, 5000);
    }
