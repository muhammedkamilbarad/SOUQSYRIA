...
<body>
    <div class="container">
        <div class="card">
            <div class="logo">
                <img src="https://i.ibb.co/k6yXNyLs/logo.png" alt="شعار سوق سوريا">
            </div>
            <h2>رمز التحقق من البريد الإلكتروني</h2>
            <p class="greeting">عزيزي {{ $userName }}،</p>
            <p class="info">شكرًا لاختيارك سوق سوريا! لإكمال عملية التحقق من بريدك الإلكتروني، يرجى استخدام رمز المرور لمرة واحدة (OTP) التالي:</p>
            <div class="otp-box">
                {{ $otp }}
            </div>
            ...
            <p class="signature">مع أطيب التحيات<br>فريق سوق سوريا</p>
        </div>
        <div class="footer">
            <p>هذه رسالة آلية، يرجى عدم الرد مباشرة على هذا البريد الإلكتروني.</p>
            <p>© {{ date('Y') }} سوق سوريا. جميع الحقوق محفوظة.</p>
